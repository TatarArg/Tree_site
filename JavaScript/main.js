...
document.addEventListener("DOMContentLoaded", function() {
    ...
    setSortSelects(buildings[0], form);  // передаем первый элемент из массива buildings
});

document.addEventListener("DOMContentLoaded", function() {
    let fieldsFirstSelect = document.getElementById('fieldsFirst');
    
    fieldsFirstSelect.addEventListener('change', handleFirstSelectChange);
});

let handleFirstSelectChange = (event) => {
